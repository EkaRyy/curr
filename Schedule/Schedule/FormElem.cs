    ...
    public partial class FormElem : Form
    {
        ...
        public static bool editObj(Elem obj)
        {
            ...
            if (fm.ShowDialog() == DialogResult.OK)
            {
                ...
                obj.pair = (Time)fm.comboPair.SelectedItem;
                obj.group = (Course)fm.comboGroup.SelectedItem;
                obj.disc = (Discipline)fm.comboDisc.SelectedItem;
                obj.teacher = (Professor)fm.comboTeacher.SelectedItem;
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            Time pair = (Time)comboPair.SelectedItem;

            Room room = (Room)comboRoom.SelectedItem;
            Course group = (Course)comboGroup.SelectedItem;
            Professor teacher = (Professor)comboTeacher.SelectedItem;
